...
!(function () {
  var e = {
      ...
      463: function (e, t, n) {
        ...
        function Vl(e, t, n, r) {
          ...
          'object' === typeof l && null !== l
            ? (a.context = El(l))
            : ((l = za(t) ? Na : Ta.current), (a.context = Ra(e, l))),
        ...
        function gs(e, t) {
          ...
          if ((kl(), (Tu = n), (Eu.current = r), null !== Nu))
            throw Error(l(261));
        ...
        function As(e, t, n, r, a, o) {
          ...
          if (((r = e), 'function' === typeof e)) zs(e) && (i = 1);
            ...
            e: switch (e) {
              ...
              case O:
                return (
                  ((e = Rs(13, n, t, a)).elementType = O), (e.lanes = o), e
                );
              case N:
                return (
                  ((e = Rs(19, n, t, a)).elementType = N), (e.lanes = o), e
                );
              case L:
                return Ds(n, a, o, t);
              default:
      ...
      117: function (e, t) {
        ...
        function E(e, t, r) {
          ...
          if (null != t)
            ...
            t))
              w.call(t, a) && !x.hasOwnProperty(a) && (l[a] = t[a]);
  ...
  (n.m = e),
    ...
    (n.u = function (e) {
      return 'static/js/' + e + '.06b5d477.chunk.js';
    }),
    ...
    (function () {
      ...
      var t = function (t, r) {
        ...
        r = (self.webpackChunkprogress_bars =
          self.webpackChunkprogress_bars || []);
    ...
    (function () {
          ...
          function t(e, r, u, s, d) {
                  ...
                  case 123:
                    ...
                    if (
                      ...
                      if (
                        ...
                        0 < L &&
                          ((S = i(3, m, (F = n(R, B, M)), r, T, P, j, h, d, s)),
                          (B = F.join('')),
                          void 0 !== S &&
                            0 === (j = (m = S.trim()).length) &&
                            ((h = 0), (m = ''))),
                ...
                case 10:
                  47 === C
                    ...
                    : 0 === 1 + p &&
                      ...
                      0 < B.length &&
                      ((F = 1), (B += '\0')),
                    0 < L * I && i(0, B, r, e, T, P, H.length, s, d, s),
                    (P = 1),
                    T++;
                  break;
                case 59:
            ...
            if (0 < (j = H.length)) {
              if (
                ((F = r),
                0 < L &&
                  void 0 !== (S = i(2, H, F, e, T, P, j, s, d, s)) &&
                  0 === (H = S).length)
              )
                return V + H + W;
              if (((H = F.join(',') + '{' + H + '}'), 0 !== N * O)) {
      ...
      var z = (function () {
        ...
        M = function (e, t) {
          t >= I && (I = t + 1), L.set(e, t), A.set(t, e);
        },
        j = 'style[' + T + '][data-styled-version="5.3.6"]',
        U = new RegExp(
          '^' + T + '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)',
        ),
        $ = function (e, t, n) {
            ...
            if (o) {
              ...
              if (i) {
                var u = 0 | parseInt(i[1], 10),
                  s = i[2];
                0 !== u &&
                  (M(s, u), $(e, s, i[3]), e.getTag().insertRules(u, r)),
                  (r.length = 0);
              } else r.push(o);
            }
          }
        ...
        q = O,
        Y = { isServer: !O, useCSSOMInjection: !N },
        G = (function () {
          function e(e, t, n) {
            void 0 === e && (e = x),
              void 0 === t && (t = {}),
            ...
            (e.prototype.generateAndInjectStyles = function (e, t, n) {
              ...
              if (
                ...
                if (this.staticRulesId && t.hasNameForId(r, this.staticRulesId))
                  ...
                  var l = we(this.rules, e, t, n).join(''),
        ...
        return ke(e)
          ...
          ? (function e(t, n) {
              ...
              for (var o in t)
                t.hasOwnProperty(o) &&
                  !ke(t[o]) &&
                  ((Array.isArray(t[o]) && t[o].isCss) || E(t[o])
                    ? l.push(Se(o) + ':', t[o], ';')
                    : w(t[o])
          ...
          k = function (t, n) {
            return (function (t, n, r, a) {
              var l = t.attrs,
                ...
                })(Ee(n, (0, e.useContext)(Ie), i) || x, n, l),
                p = d[0],
                h = d[1],
                m = (function (e, t, n, r) {
                  var a = de(),
                    l = pe();
                  return t
                    ? e.generateAndInjectStyles(x, a, l)
              ...
              for (var C in k)
                '$' !== C[0] &&
                  ...
                  ('forwardedAs' === C
                    ? (w.as = k[C])
                    : (s ? s(C, v, y) : !b || v(C)) && (w[C] = k[C]));
              return (
                n.style &&
                  h.style !== n.style &&
                  (w.style = S({}, n.style, {}, h.style)),
      ...
      var Me = function (e) {
        return (function e(t, n, r) {
          if ((void 0 === r && (r = x), !(0, f.isValidElementType)(n)))
            return R(1, String(n));
          var a = function () {
            return t(n, r, xe.apply(void 0, arguments));
          };
          return (
      ...
      var je,
        ...
        Ge = Qe.div(
          ...
          function (e) {
            return e.percentage > 100 ? '#e53e3e' : '#90cdf4';
          },
          function (e) {
            return e.percentage > 100 ? 100 : ''.concat(e.percentage, '%');
          },
        ),
        Xe = Qe.div(
          $e ||
        ...
        Ze = function (e) {
          var t = e.progressBars;
          return (0, Ke.jsxs)(Je, {
            children: [
              (0, Ke.jsx)('h1', { children: 'Progress Bars' }),
              (0, Ke.jsx)(et, {
                children: t.map(function (e) {
                  return (0, Ke.jsx)(qe, { percentage: e.percentage }, e.id);
                }),
              }),
            ],
          });
        ...
        tt = function (e) {
          var t = e.change,
            n = e.handlePercentageChange;
          return (0, Ke.jsx)('button', {
            onClick: function () {
              return n(t);
            },
            'data-testid': 'progress-bars__control-button_'
              .concat(t < 0 ? 'minus' : 'plus', '-')
              .concat(Math.abs(t)),
            children: t > 0 ? '+'.concat(t) : t,
          });
        },
        nt = [-25, -10, 10, 25],
        rt = function (e) {
          var t = e.progressBars,
            n = e.selectedBarId,
            r = e.setSelectedBarId,
            a = e.setSelectedBarPercentage,
            l = function (e) {
          ...
          return (0, Ke.jsxs)(at, {
            'data-testid': 'progress-bars__control-panel',
            children: [
              (0, Ke.jsx)('select', {
                value: n,
                onChange: function (e) {
                ...
                children: t.map(function (e) {
                  return (0,
                  Ke.jsx)('option', { value: e.id, children: e.name }, e.id);
                }),
              }),
              nt.map(function (e) {
                return (0,
                Ke.jsx)(tt, { handlePercentageChange: l, change: e }, e);
              }),
            ],
          });
        },
        ...
        ot = function () {
          var t = c((0, e.useState)(lt), 2),
            n = t[0],
            r = t[1],
            a = c((0, e.useState)('progress-1'), 2),
            l = a[0],
            i = a[1];
          return (0, Ke.jsxs)(it, {
            children: [
              (0, Ke.jsx)(Ze, { progressBars: n }),
              (0, Ke.jsx)(rt, {
                progressBars: n,
                selectedBarId: l,
                setSelectedBarId: i,
                setSelectedBarPercentage: function (e, t) {
                  var a = s(n),
                    l = a.findIndex(function (t) {
                      return t.id === e;
                    });
                  -1 !== l &&
                    (a.splice(l, 1, o(o({}, a[l]), {}, { percentage: t })),
                    r(a));
                },
              }),
            ],
      ...
      t
        ...
        .render((0, Ke.jsx)(e.StrictMode, { children: (0, Ke.jsx)(ut, {}) })),
        st();
    })();
})();
